        ...
        if column_key == 'material_code':
            ...
            if self.on_material_lookup and value:
                ...
                if material:
                    ...
                    # Material not found - clear name and show warning
                    values[2] = '⚠️ Bulunamadı'
                    values[4] = ''  # solid_weight
                    values[5] = ''  # price
                    self.tree.item(item_id, values=values, tags=('warning',))
